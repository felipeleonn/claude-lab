...
@mcp.tool(
    ...
    description="Read the contents of a document and return the contents as a string",
)
...
@mcp.tool(
    name="edit_document",
    description="Edit a docuemnt by replacing a string in the documents content with a new string"
)
...
def summarize_document(
    ...
    prompt = f"""
    Your goal is to summarize a document concisely.
    ...
    of its contents. Focus on the key points and main ideas.
    """
